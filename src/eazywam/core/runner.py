...
from eazywam.core.runtime import INPUT_RUN_SPEC, RUN_SPEC
...
from eazywam.workloads.processor_smoke import ProcessorSmokeWorkload
from eazywam.workloads.single_observation import SingleObservationWorkload
